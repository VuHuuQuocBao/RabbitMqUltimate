...
namespace RabbitMqUltimate.EventBus.Core.EventsImplementation
{
    public class EventBusSubscriptionsManager : IEventBusSubscriptionsManager
    {
        ...
        IEnumerable<Events.SubscriptionInfo> IEventBusSubscriptionsManager.GetHandlersForEvent<T>()
        => GetHandlersForEvent(GetEventKey<T>());

        IEnumerable<Events.SubscriptionInfo> IEventBusSubscriptionsManager.GetHandlersForEvent(string eventName)
        {
            _handlers.TryGetValue(eventName, out List<Events.SubscriptionInfo> result);
            return result;
        }
    }
